...
import org.openqa.selenium.firefox.FirefoxDriver;
	...
	public class EncontrarElementos {
		...
		public static void main(String[] args) {
			...
			driver.findElement(By.xpath("//div[@class='signin-wrapper']//input[@name='session[username_or_email]']")).sendKeys("karin_bez@hotmail.com");
			driver.findElement(By.xpath("//div[@class='signin-wrapper']//input[@name='session[password]']")).sendKeys("kaka5482");
